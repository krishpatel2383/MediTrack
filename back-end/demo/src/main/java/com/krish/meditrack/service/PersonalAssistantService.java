...
public class PersonalAssistantService {
	...
	public Optional<PersonalAssistant> loginPersonalAssistant(String email, String password) {
		Optional<PersonalAssistant> optionalPersonalAssistant = personalAssistantRepository.findByEmail(email);

		if (optionalPersonalAssistant.isPresent()) {
			PersonalAssistant personalAssistant = optionalPersonalAssistant.get();
			if (personalAssistant.getPassword().equals(password)) {
				return Optional.of(personalAssistant);
			}
		}
