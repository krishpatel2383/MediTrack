...
@RestController
@RequestMapping("/api/personal_assistant")
public class PersonalAssistantController {
	...
	@GetMapping("{personalAssistantId}/doctor")
	public ResponseEntity<Doctor> getDoctorByPersonalAssistant(@PathVariable int personalAssistantId) {
		PersonalAssistant personalAssistant = personalAssistantService.getPersonalAssistantById(personalAssistantId);
		Doctor doctor = personalAssistant.getDoctor();
